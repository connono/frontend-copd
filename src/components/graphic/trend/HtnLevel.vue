...
<script>
    ...
    export default class HtnLevel extends Base {
        rangeMonth = 1
        errSummary = ""
        errDetail = ""
        isLoading = false
        ...
        drawTrend(ctx, width, height, offsetLeft, offsetRight, offsetTop, offsetBottom) {
            ...
            ctx.fillText("一级管理", ox - txtPaddingX, yFirstLevel);
            ctx.fillText("二级管理", ox - txtPaddingX, ySecondLevel);
        ...
        getData() {
            ...
            this.isLoading = true;
            this.post(this.uris.manageHtnLevelTrend, argument, this.onGetData);
        }
